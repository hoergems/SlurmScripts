...
parser.add_argument('-to', '--timeout', type=int, default=20, help="Timeout of scripts in minutes")
...
for i in xrange(1, numConvarianceSteps + 1):
	...
	if numObstacles > 0:
	    folder2 = str(numObstacles) + "_obstacles/" + str(i) + "_proc_" + str(j) + "_obs"
	for k in xrange(0, numRuns/numParallelJobs):	    
	    ...
	    string += "#SBATCH --time=00:" + str(timeout) + ":00 \n"	    
