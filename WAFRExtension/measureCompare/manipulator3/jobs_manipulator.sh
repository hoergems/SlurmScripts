...
./measureCompareObst_manipulator --cfg /data/hoe01h/WAFRExtension/ConfigFiles/WAFRExtension/measureCompare/manipulator3/manipulator$SLURM_ARRAY_TASK_ID.cfg
